        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <main className="lg:col-span-3">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {companies?.map((company: { id: number; featured_image: string; company_name: string; translations: { languages_code: string; slug_permalink: string; seo_description?: string; }[]; }) => (
